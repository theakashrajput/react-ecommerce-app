...
const HomePageSalesSec = (props) => {
  return (
    <>
      ...
      <button className="w-[95%] lg:max-w-xs bg-transparent text-[#000] rounded-3xl py-3 text-base mt-5 lg:mt-8 border-[1px] border-[#A2A0A1] cursor-pointer active:scale-95">
        View All
      </button>
    </>
  );
